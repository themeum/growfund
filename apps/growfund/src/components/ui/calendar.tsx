...
function Calendar({ className, classNames, showOutsideDays = true, ...props }: CalendarProps) {
  return (
    <DayPicker
      ...
      className={cn('growfund-p-3 growfund-calendar growfund-w-full', className)}
      classNames={{
        months:
          'growfund-flex growfund-flex-col sm:growfund-flex-row growfund-space-y-4 sm:growfund-space-x-4 sm:growfund-space-y-0',
        month: 'growfund-space-y-4',
        caption:
          'growfund-flex growfund-justify-center growfund-pt-1 growfund-relative growfund-items-center',
        ...
        head_row: 'growfund-flex growfund-w-full',
        head_cell:
          'growfund-text-fg-muted growfund-rounded-md growfund-flex-1 growfund-text-center growfund-font-normal growfund-text-[0.8rem]',
        row: 'growfund-flex growfund-w-full growfund-mt-2',
        cell: cn(
          'growfund-relative growfund-p-0 growfund-flex-1 growfund-text-center growfund-typo-small focus-within:growfund-relative focus-within:growfund-z-20 [&:has([aria-selected])]:growfund-bg-accent [&:has([aria-selected].growfund-day-outside)]:growfund-bg-accent/50 [&:has([aria-selected].growfund-day-range-end)]:growfund-rounded-r-md',
          props.mode === 'range'
        ...
        day: cn(
          ...
          'lg:growfund-h-8 growfund-w-full lg:growfund-w-8 growfund-p-0 growfund-font-normal aria-selected:growfund-opacity-100',
        ),
        ...
        day_range_middle:
          'growfund-day-range-middle growfund-bg-background-fill-secondary growfund-text-fg-primary',
