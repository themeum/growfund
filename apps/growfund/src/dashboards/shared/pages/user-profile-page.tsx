  ...
  return (
    <Container className="growfund-mt-10 growfund-space-y-3" size="sm">
      <Box className="growfund-border-none growfund-shadow-none">
        <BoxContent className="growfund-flex growfund-flex-col sm:growfund-flex-row growfund-items-start sm:growfund-items-center growfund-gap-4 growfund-relative">
          <Avatar className="growfund-shrink-0 growfund-size-16 sm:growfund-size-[5.5rem]">
          ...
          <div className="growfund-space-y-3 growfund-w-full">
            <h4 className="growfund-typo-h5 sm:growfund-typo-h4 growfund-font-semibold growfund-text-fg-primary growfund-flex growfund-flex-wrap growfund-items-center growfund-gap-2">
              <span className="growfund-break-all growfund-line-clamp-2 growfund-max-w-full sm:growfund-max-w-96">
            ...
            <div className="growfund-flex growfund-flex-col sm:growfund-flex-row sm:growfund-items-center growfund-gap-2 growfund-typo-tiny">
          ...
          <Button
            variant="secondary"
            size="sm"
            className="growfund-w-full sm:growfund-w-auto sm:growfund-absolute sm:growfund-top-1/2 sm:growfund-right-6 sm:growfund-translate-y-[-50%]"
            onClick={() => {
      ...
      <Box className="growfund-border-none growfund-shadow-none">
        <BoxContent>
          ...
          <div className="growfund-space-y-4 growfund-mt-3">
            {/* First & Last Name */}
            <div className="growfund-grid growfund-grid-cols-1 sm:growfund-grid-cols-2 growfund-gap-3">
            ...
            <div className="growfund-grid growfund-grid-cols-1 sm:growfund-grid-cols-2 growfund-gap-3">
              <div className="growfund-flex growfund-flex-col growfund-gap-1">
                ...
                <span className="growfund-typo-small growfund-text-fg-primary growfund-break-all">
                  {user.email}
                </span>
              </div>
              ...
              {isBacker && (
                <>
                  <div className="growfund-flex growfund-flex-col growfund-gap-1">
                    ...
                    <span className="growfund-typo-small growfund-text-fg-primary growfund-break-words">
