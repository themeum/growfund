        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#FFFFFF;background-color:#FFFFFF;width:100%;border-radius:6px;">
            <tbody>
                <tr>
                    ...
                    font-weight:500; color:#636363; width:180px;"><?php echo esc_html__('Amount', 'growfund'); ?></td>
                    ...
                    font-weight:500; color:#333333;">
                                                ...
                                                <tr>
                                                    <td style="padding:12px 16px; border-right:1px solid #f0f0f0; border-bottom:1px solid #f0f0f0;
                    font-weight:500; color:#636363;"><?php echo esc_html__('Campaign', 'growfund'); ?></td>
                                                    <td style="padding:12px 16px; border-bottom:1px solid #f0f0f0;
                    font-weight:500; color:#333333;">
                    ...
                    font-weight:500; color:#636363;"><?php echo esc_html__('Payment Instructions', 'growfund'); ?> </td>
                                                    <td style="padding:12px 16px; font-weight:500; color:#333333;"><?php echo esc_html($pledge['payment_instructions']); ?></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
