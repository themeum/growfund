                                    ...
                                    <td align="left" style="font-size:0px;padding:0;word-break:break-word;">
                                        <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#333333;font-family:Inter, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;border:none;border:1px solid #f0f0f0;">
                                            <tr style="border-bottom:1px solid #f0f0f0;">
                                                <td style="padding: 8px 16px; color: inherit; font-weight: 500; width: 30%;"><?php echo esc_html__('Username', 'growfund'); ?></td>
                                                <td style="padding: 8px 16px; font-weight: bold; color: inherit;border-left:1px solid #f0f0f0;"><?php echo esc_html($data['username']); ?></td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 16px; color: inherit; font-weight: 500;"><?php echo esc_html__('Email', 'growfund'); ?></td>
                                                <td style="padding: 8px 16px; font-weight: bold; color: inherit;border-left:1px solid #f0f0f0;"><?php echo esc_html($data['email']); ?></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
