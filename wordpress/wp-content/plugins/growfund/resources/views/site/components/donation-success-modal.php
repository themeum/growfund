...
<div class="growfund-modal is-open">
    ...
    <div class="growfund-modal__content growfund_contribution_success_modal_container">
        ...
        <h1 class="growfund_title"><?php echo esc_html(!empty($contribution->confirmation_title) ? $contribution->confirmation_title : __('Donation Successful', 'growfund')); ?></h1>
        <p class="growfund_subtitle"><?php echo esc_html(!empty($contribution->confirmation_description) ? $contribution->confirmation_description : __('Thank you for donating this campaign. Your support brings the campaign closer to life.', 'growfund')); ?></p>

        <div class="growfund_divider"></div>

        <div class="growfund_total_contribution">
            <div class="growfund_total_label"><?php echo esc_html__('Total Donation Campaign', 'growfund'); ?></div>
        ...
        <div class="growfund_details_grid">
            <div class="growfund_detail_item <?php echo esc_attr(growfund_settings(AppSettings::CAMPAIGNS)->allow_fund() ? '' : 'full'); ?>">
            ...
            <?php if (growfund_settings(AppSettings::CAMPAIGNS)->allow_fund()) : ?>
                <div class="growfund_detail_item">
                    <div class="growfund_detail_label"><?php echo esc_html__('Fund', 'growfund'); ?></div>
                    <div class="growfund_detail_value"><?php echo esc_html($contribution->fund_title ?? 'N/A'); ?></div>
                </div>
            <?php endif; ?>
            <div class="growfund_detail_item">
        ...
        <div class="growfund_details_grid">
            <div class="growfund_detail_item">
                <div class="growfund_detail_label"><?php echo esc_html__('Donor Name', 'growfund'); ?></div>
