...
class PledgeCreatedMail extends Mailer
{
    protected $content_key = MailKeys::BACKER_PLEDGE_CREATED;
    ...
    public function with($data)
    {
        ...
        return parent::with([
            ...
            'information_card' => growfund_renderer()->get_html('mails.components.backer.pledge-information-card', [
                'campaign' => $campaign
            ]),
