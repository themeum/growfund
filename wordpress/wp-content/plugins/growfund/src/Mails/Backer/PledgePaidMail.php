...
class PledgePaidMail extends Mailer
{
    protected $content_key = MailKeys::BACKER_PLEDGE_PAID;
    ...
    public function with($data)
    {
        ...
        if (empty($pledge_dto->backer->email) || $pledge_dto->status !== PledgeStatus::BACKED) {
            $this->ignore_mail();
        }
        ...
        $receipt_url = growfund_pledge_receipt_download_url($pledge_dto->uid);
